# prplOS Build Instructions : prplware-v5.0.0 : BPI-R4

## Overview

This document provides step-by-step instructions to build prplOS image for **Banana Pi R4** using the **prplware-v5.0.0** release.
...
[prplware-v5.0.0 Patches](https://github.com/dineshloganathan395/bpi-r4-dev-resources/tree/main/prplos/prplware-v5.0.0/patches)
and copy into `~/Downloads/bpi-r4-dev-resources/prplos/prplware-v5.0.0/patches/`.

---

## Step 1 : Initialize prplOS Repository

* Clone prplOS repo and checkout prplware-v5.0.0 release using the below commands

```bash
git clone https://gitlab.com/prpl-foundation/prplos/prplos.git
cd prplos
git checkout prplware-v5.0.0
```
...
```bash
git am ~/Downloads/bpi-r4-dev-resources/prplos/prplware-v5.0.0/patches/prplos/*.patch
```
...
git am ~/Downloads/bpi-r4-dev-resources/prplos/prplware-v5.0.0/patches/feed_mediatek/*.patch
cd ../..
```
